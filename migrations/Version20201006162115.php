 ...
 */
final class Version20201006162115 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, publication_date_id INT NOT NULL, category_id INT NOT NULL, header_image_id INT NOT NULL, writer_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_23A0E66B01EE057 (publication_date_id), INDEX IDX_23A0E6612469DE2 (category_id), INDEX IDX_23A0E668C782417 (header_image_id), INDEX IDX_23A0E661BC7E6B6 (writer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
